...
export default function Web() {
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-screen-xl px-4 py-8 text-center lg:py-16 relative z-10">
          <div className="mx-auto place-self-center">
            ...
            <p className={textStyle}>
              Eitan Research Consultant empowers businesses grow with three key services: <a href={automationLink} className="text-blue-700 font-bold hover:underline">Automation</a>, <a href={consultingLink} className="text-blue-700 font-bold hover:underline">Consulting</a> for startups and tech companies, and <a href={teachingLink} className="text-blue-700 font-bold hover:underline">Training</a>. We make your operations smarter, offer expert advice, and teach the skills needed to succeed in today’s tech world with AI.
            </p>
      ...
      <section className="mx-auto grid max-w-screen-xl px-4 py-8 text-center lg:py-16 relative z-10">
        <Image
          src="/tel_aviv2.png"
          alt="Tel Aviv"
          fill
          ...
          priority
        />
        <div className="mx-auto place-self-center relative">
